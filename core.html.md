...
In the default configuration, `ok_ops` permits pipes, input redirection,
and logical/sequential operators — but blocks output redirection.
`ok_cmds` contains a generous set of read-only commands plus some safe
git operations. Note that `find` blocks dangerous flags like `-exec`:
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L133"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L158"
target="_blank" style="float:right; font-size:smaller">source</a>
...
subshells), except output redirection. rm\_ params are comma-separated
strs.
...
```
    ...
    {'error': __main__.DisallowedCmd('head -2')}

``` python
bash('sudo ls')
```

    {'error': __main__.DisallowedCmd('sudo ls')}

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L172"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L202"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L198"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'error': __main__.DisallowedCmd('ls -l')}
