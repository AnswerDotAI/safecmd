...
```
    ...
    find !{'-ok', '-delete', '-okdir'} exec={'-exec', '-execdir'}
...
```
    ...
    wget allowed: True
    cat allowed: False
    dests: {'/Users/jhoward/git', './', '/dev/null', '/Users/jhoward/aai-ws', '~/Downloads'}
...
The functions in this section wrap
[`safe_run`](https://AnswerDotAI.github.io/safecmd/core.html#safe_run)
suitable for LLM usage.

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L313"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L448"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
test_fail(lambda: rg("--pre cat foo ."), exc=DisallowedCmd)
test_fail(lambda: rg("--hostname-bin evil foo ."), exc=DisallowedCmd)
...
<a
href="https://github.com/AnswerDotAI/safecmd/blob/main/safecmd/core.py#L457"
target="_blank" style="float:right; font-size:smaller">source</a>
