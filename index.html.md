...
```
    ...
    [36mFile [39m[32m~/aai-ws/safecmd/safecmd/core.py:257[39m, in [36msafe_run[39m[34m(cmd, cmds, dests, add_cmds, add_dests, rm_cmds, rm_dests, ignore_ex)[39m
    [32m    254[39m eff_cmds |= _split_specs(add_cmds)
    [32m    255[39m eff_cmds -= {CmdSpec(c) [38;5;28;01mfor[39;00m c [38;5;129;01min[39;00m _split_set(rm_cmds)}
    [32m--> [39m[32m257[39m [43mvalidate[49m[43m([49m[43mcmd[49m[43m,[49m[43m [49m[43meff_cmds[49m[43m,[49m[43m [49m[43meff_dests[49m[43m)[49m
    [32m    258[39m [38;5;28;01mreturn[39;00m run(cmd, ignore_ex=ignore_ex)

    [36mFile [39m[32m~/aai-ws/safecmd/safecmd/core.py:233[39m, in [36mvalidate[39m[34m(cmd, cmds, dests)[39m
    [32m    231[39m commands, ops, redirects = extract_commands(cmd, exec_flags=exec_flags, dest_flags=dest_flags)
    [32m    232[39m [38;5;28;01mfor[39;00m c [38;5;129;01min[39;00m commands:
    [32m--> [39m[32m233[39m     [38;5;28;01mif[39;00m [38;5;129;01mnot[39;00m validate_cmd(c, cmds): [38;5;28;01mraise[39;00m DisallowedCmd(c)
    [32m    234[39m [38;5;28;01mfor[39;00m op, dest [38;5;129;01min[39;00m redirects:
    [32m    235[39m     [38;5;28;01mif[39;00m [38;5;129;01mnot[39;00m validate_dest(dest, dests): [38;5;28;01mraise[39;00m DisallowedDest(dest)
...
```
    ...
    [36mFile [39m[32m~/aai-ws/safecmd/safecmd/core.py:235[39m, in [36mvalidate[39m[34m(cmd, cmds, dests)[39m
    [32m    233[39m     [38;5;28;01mif[39;00m [38;5;129;01mnot[39;00m validate_cmd(c, cmds): [38;5;28;01mraise[39;00m DisallowedCmd(c)
    [32m    234[39m [38;5;28;01mfor[39;00m op, dest [38;5;129;01min[39;00m redirects:
    [32m--> [39m[32m235[39m     [38;5;28;01mif[39;00m [38;5;129;01mnot[39;00m validate_dest(dest, dests): [38;5;28;01mraise[39;00m DisallowedDest(dest)
